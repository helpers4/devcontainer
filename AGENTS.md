...
| ------- | --- | ----------- |
| `helpers4-common` | 1.3.0 | Bootstrap: `common.sh` (root check, user detection, apt helpers, cloud-env detection) + automatic git-config self-heal on every attach — all features depend on this |
