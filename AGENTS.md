...
| ------- | --- | ----------- |
| `helpers4-common` | 1.2.2 | Bootstrap: `common.sh` (user detection, apt helpers, cloud-env detection) + automatic git-config self-heal on every attach — all features depend on this |
