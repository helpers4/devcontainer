...
# Mistral Vibe can write into it. Only chown when needed — a recursive chown
# on a populated volume shared across rebuilds isn't free. (Same pattern as
# pnpm-store's guard script.)
